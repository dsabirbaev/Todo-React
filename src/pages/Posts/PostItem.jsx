  ...
  return (
    ...
    <ToastContainer />
      <div className="flex justify-between items-center">
        ...
        <button onClick={() => navigate(-1)} className="bg-red-600 px-3 py-2 top-0 rounded-lg text-white right-1 ">
          Back
        </button>
      </div>
      ...
      <div className="p-4 shadow border-dashed border-lime-500 bg-slate-500 relative">
        ...
        <button onClick={() => deleteItem(id)} className="bg-red-600 absolute py-2 px-4 top-2 rounded-lg text-white right-1">
          Delete
        </button>
      </div>
    </>
